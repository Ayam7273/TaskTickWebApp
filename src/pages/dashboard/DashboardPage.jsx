...
export default function DashboardPage() {
	const { getTodayTasks, toggleTask, deleteTask, calculateFreeTime, addTask, updateTask } = useTasks();
	const [isAddModalOpen, setIsAddModalOpen] = useState(false);
	const [isSortModalOpen, setIsSortModalOpen] = useState(false);
	const [editingTask, setEditingTask] = useState(null);
	const [sortBy, setSortBy] = useState('start-time-latest-bottom');
	...
	return (
		<div className="space-y-6 pb-20">
			<div className="flex items-center justify-between">
				<div className="heading-xl">TaskTick</div>
			...
			<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
				...
				<Card className="p-4">
					...
					<div className="text-2xl font-semibold mt-2">{freeTime}</div>
				</Card>
			...
			<div className="flex items-center justify-between">
				<div className="heading-lg">Today Tasks</div>
				<button
